...
CREATE INDEX IF NOT EXISTS idx_teacher_assignments_composite ON teacher_assignments(teacher_id, class_id, subject_id);
...
CREATE INDEX IF NOT EXISTS idx_marks_student_exam ON marks(student_id, exam_type);
CREATE INDEX IF NOT EXISTS idx_marks_updated_at ON marks(updated_at DESC);
...
-- CREATE RLS POLICIES
CREATE POLICY "Anyone can read students" ON students FOR SELECT TO anon, authenticated USING (true);
CREATE POLICY "Anyone can insert students" ON students FOR INSERT TO anon, authenticated WITH CHECK (true);
CREATE POLICY "Anyone can update students" ON students FOR UPDATE TO anon, authenticated USING (true) WITH CHECK (true);
CREATE POLICY "Anyone can delete students" ON students FOR DELETE TO anon, authenticated USING (true);

CREATE POLICY "Anyone can read teachers" ON teachers FOR SELECT TO anon, authenticated USING (true);
CREATE POLICY "Anyone can insert teachers" ON teachers FOR INSERT TO anon, authenticated WITH CHECK (true);
CREATE POLICY "Anyone can update teachers" ON teachers FOR UPDATE TO anon, authenticated USING (true) WITH CHECK (true);
CREATE POLICY "Anyone can delete teachers" ON teachers FOR DELETE TO anon, authenticated USING (true);

CREATE POLICY "Anyone can read admins" ON admins FOR SELECT TO anon, authenticated USING (true);
CREATE POLICY "Anyone can manage admins" ON admins FOR ALL TO anon, authenticated USING (true) WITH CHECK (true);

CREATE POLICY "Anyone can read classes" ON classes FOR SELECT TO anon, authenticated USING (true);
CREATE POLICY "Anyone can manage classes" ON classes FOR ALL TO anon, authenticated USING (true) WITH CHECK (true);

CREATE POLICY "Anyone can read subjects" ON subjects FOR SELECT TO anon, authenticated USING (true);
CREATE POLICY "Anyone can manage subjects" ON subjects FOR ALL TO anon, authenticated USING (true) WITH CHECK (true);

CREATE POLICY "Anyone can read teacher assignments" ON teacher_assignments FOR SELECT TO anon, authenticated USING (true);
CREATE POLICY "Anyone can manage teacher assignments" ON teacher_assignments FOR ALL TO anon, authenticated USING (true) WITH CHECK (true);

CREATE POLICY "Anyone can read marks" ON marks FOR SELECT TO anon, authenticated USING (true);
CREATE POLICY "Anyone can insert marks" ON marks FOR INSERT TO anon, authenticated WITH CHECK (true);
CREATE POLICY "Anyone can update marks" ON marks FOR UPDATE TO anon, authenticated USING (true) WITH CHECK (true);
CREATE POLICY "Anyone can delete marks" ON marks FOR DELETE TO anon, authenticated USING (true);

CREATE POLICY "Anyone can read marks history" ON marks_history FOR SELECT TO anon, authenticated USING (true);
CREATE POLICY "Anyone can insert marks history" ON marks_history FOR INSERT TO anon, authenticated WITH CHECK (true);

CREATE POLICY "Anyone can read gallery images" ON gallery_images FOR SELECT TO anon, authenticated USING (true);
CREATE POLICY "Anyone can manage gallery images" ON gallery_images FOR ALL TO anon, authenticated USING (true) WITH CHECK (true);

CREATE POLICY "Anyone can read notices" ON notices FOR SELECT TO anon, authenticated USING (true);
CREATE POLICY "Anyone can manage notices" ON notices FOR ALL TO anon, authenticated USING (true) WITH CHECK (true);
